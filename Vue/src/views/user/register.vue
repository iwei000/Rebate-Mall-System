    ...
    >
      <div class="block">
        ...
        <div class="p_agr">
          ...
          <p>
            如对本《隐私政策》或相关事宜有任何问题，请通过zhongshunleyi@163.com与我们联系。
          </p>
          <p>我们可能收集的信息</p>
          <p>
          ...
          beacon承担责任。 您可以通过浏览器设置拒绝或管理cookies或web
    ...
    >
      <div class="block">
        ...
        <div class="p_agr">
          ...
          <p>
            5、虚拟财产转移服务外，用户不得通过任何方式直接或变相进行账号资产的转移。
          </p>
          <p>
            6、用户不得从事作弊等损害公平性的行为。用户承诺接受本公司对其游戏数据进行分析，当本公司发现其数据异常时，本公司可根据自己的独立判断认定其为作弊。
          </p>
          <p>
